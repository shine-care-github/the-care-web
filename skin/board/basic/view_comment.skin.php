...
<div class="comment_skin_wrap">
  <button type="button" class="cmt_btn"><span class="total"><b>댓글</b> <?php echo $view['wr_comment']; ?></span><span class="cmt_more"><i class="fa fa-chevron-down" aria-hidden="true"></i></span></button>
  <!-- 댓글 시작 { -->
  <section id="bo_vc">
      <h2>댓글목록</h2>
      <?php
