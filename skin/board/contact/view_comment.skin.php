...
<div class="comment_skin_wrap">
  <button type="button" class="cmt_btn"><span class="total"><b>답변쓰기</b></span></button>
  <!-- 댓글 시작 { -->
  <section id="bo_vc">
      <h2>댓글목록</h2>
      <?php
          ...
          <div class="cm_wrap">
              ...
              <header style="z-index:<?php echo $cmt_sv; ?>">
                ...
                <?php if ($is_ip_view) { ?>
  	            ...
  	            <span class="bo_vc_hdinfo"><i data-feather="calendar"></i><time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', strtotime($list[$i]['datetime'])) ?>"><?php echo $list[$i]['datetime'] ?></time></span>
  	            <?php
      ...
      <?php } ?>
      <?php if ($i == 0) { //댓글이 없다면 ?><p id="bo_vc_empty">등록된 답변이 없습니다.</p><?php } ?>
  ...
  <aside id="bo_vc_w" class="bo_vc_w">
  	...
  	if($commnet_editor)
      {
          //echo editor_html("wr_content", get_text($wr_content, 1));
  		//echo editor_html("wr_content",$c_wr_content);
      echo $editor_html;
