...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:<?php echo $width; ?>"  class="width common">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_info">
                        <span class="sound_only"><i data-feather="user"></i><?php echo $list[$i]['name'] ?></span>
                        <div class="gall_info2">
                          <span class="gall_date"><i data-feather="calendar"></i><?php echo date("Y.m.d", strtotime($list[$i]['wr_datetime'])) ?></span>
                         <span class="gall_view"><span class="pro_title"><i data-feather="eye"></i></span><?php echo $list[$i]['wr_hit'] ?></span>
                        </div>
                    </div>
