  ...
  <li><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><span class="view_btn">목록</span></a></li>
    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
            ...
            <li><span class="pro_title"><i data-feather="user"></i></span><p><?php echo $view['name'] ?></p></li>
      		</ul>
          <ul class="profile_info_day">
            <li><span class="pro_title"><i data-feather="calendar"></i></span><p><?php echo date("Y-m-d", strtotime($view['wr_datetime'])) ?></p></li>
            <li> <span class="pro_title"><i data-feather="eye"></i></span><p><?php echo number_format($view['wr_hit']) ?> 회</p></li>
            <li> <span class="pro_title"><i data-feather="message-square"></i></span><p><?php echo number_format($view['wr_comment']) ?> 건</p></li>
          </ul>
      	</div>
