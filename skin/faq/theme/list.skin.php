...
<div class="board_title wow fadeInup"  data-wow-duration="1s">
  <h2  class="fs32 fw500"><?=$sNum?></h2>
</div>

<fieldset id="faq_sch" class="width">
...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?> width" style="margin-bottom:80px;">
    <?php // FAQ 내용
    if( count($faq_list) ){
    ?>
    <section id="faq_con">
